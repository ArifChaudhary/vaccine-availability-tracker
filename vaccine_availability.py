...
#app.iconbitmap("covid.ico")
app.resizable(True, True)
app.config(background = '#adb5bd')

#DEFAULT values
PINCODE = '140301'

# Color value reference
top_left_frame_bg  = "#198754"
top_right_frame_bg = '#198754'
...
frame3 = Frame(app, height = 30, width=700, bg= '#fff', bd=1, relief = RAISED)
...
label_head_result = Label(text=" Status       \tCentre-Name\t              Age-Group    Vaccine       Dose_1     Dose_2     Total", bg = '#20c997', fg='white', font = 'Verdana 8 bold')
label_head_result.place(x=10, y=125)


# Entry boxes
pincode_text_var = StringVar()
pincode_textbox = Entry(app,width = 11, bg = '#fff', fg= 'black', textvariable = pincode_text_var, font='verdana 11')
pincode_textbox['textvariable'] = pincode_text_var
pincode_textbox.place(x= 220, y=40)

date_text_var = StringVar()
date_textbox = Entry(app,width = 12, bg = '#fff', fg= 'black', textvariable = date_text_var, font='verdana 10')
...
# Buttons
search_vaccine_image = PhotoImage(file= "covid1.png")
